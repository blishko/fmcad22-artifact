; chc-comp19-benchmarks/./lra-ts/chc-lra-ts-0139_000.smt2
(set-logic HORN)
    ...
    (=>
      ...
      (a!30 (or (and (= S3 I)
                ...
                (and (= S3 I)
                     ...
                     (not (= I 4513.0))
                     (= I 4529.0)))))
(let ((a!3 (or (and a!2 (= B4 N4) (= J 2.0) (= V (- 256.0)) (= N1 3.0))
               (and a!2
                    (= B4 N4)
                    (not (= J 4.0))
                    (not (= J 2.0))
      ...
      (a!12 (or (and a!11 (not (<= B4 0.0)) (= A4 4480.0) (= B4 I4) (= A1 0.0))
                (and a!11
                     (not (<= B4 0.0))
                     (= A4 4464.0)
                     (= B4 I4)
...
(let ((a!4 (or (and a!3 (not (<= B4 0.0)) (= L D4))
      ...
      (a!10 (or (and a!6 (not (<= B4 0.0)) (= A4 4384.0))
