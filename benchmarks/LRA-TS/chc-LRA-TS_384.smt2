; chc-comp19-benchmarks/./lra-ts/chc-lra-ts-0111_000.smt2
(set-logic HORN)
    ...
    (=>
      (and
        (invariant A
           ...
           T1
           U1)
        (let ((a!1 (or (and G1 (not (= R1 O1)))
               (and H1 (not (= R1 P1)))
               (and I1 (not (= R1 Q1)))))
      (a!2 (or (and J1 (not (= O1 R1)))
               (and H1 (not (= O1 P1)))
               (and I1 (not (= O1 Q1)))))
      (a!3 (or (and J1 (not (= P1 R1)))
               (and G1 (not (= P1 O1)))
               (and I1 (not (= P1 Q1)))))
      (a!4 (or (and J1 (not (= Q1 R1)))
               (and G1 (not (= Q1 O1)))
               (and H1 (not (= Q1 P1))))))
  (and (or (and J1 a!1) (and G1 a!2) (and H1 a!3) (and I1 a!4)) (<= 3.0 S1)))
      )
      false
    )
  )
