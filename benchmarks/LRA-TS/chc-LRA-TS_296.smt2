; chc-comp19-benchmarks/./lra-ts/chc-lra-ts-0142_000.smt2
(set-logic HORN)
...
(let ((a!3 (or (and a!2 (= B4 N4) (not (= J 2.0)) (= V 256.0) (= N1 J))
      ...
      (a!6 (or (and a!5 (= B4 M4) (= J 0.0) (= N1 1.0))
               (and a!5 (= B4 M4) (not (= J 0.0)) (not (= J 4.0)) (= N1 J))
               (and a!5 (= B4 M4) (not (= J 0.0)) (= J 4.0) (= N1 5.0))))
      (a!8 (or (and a!7 (= B4 L4) (not (= J 1.0)) (= N1 J))
               (and a!7 (= B4 L4) (= J 1.0) (= N1 2.0))))
...
(let ((a!4 (or (and a!3 (not (<= B4 0.0)) (= L D4))
      ...
      (a!23 (or (and a!22 (= D R3) (not (= R 0.0)) (= S 66048.0) (= D3 R))
                (and a!22
                     (= R3 O4)
                     (not (= R3 0.0))
                     (not (= M 0.0))
