; chc-comp19-benchmarks/./lra-ts/chc-lra-ts-0181_000.smt2
(set-logic HORN)
    ...
    (=>
      (and
        (invariant A
           ...
           R4
           S4)
        (let ((a!1 (or (and A4 (not (= O4 P4)))
               (and W3 (not (= O4 L4)))
               (and X3 (not (= O4 M4)))
               (and Y3 (not (= O4 N4)))))
      (a!2 (or (and Z3 (not (= P4 O4)))
               (and W3 (not (= P4 L4)))
               (and X3 (not (= P4 M4)))
               (and Y3 (not (= P4 N4)))))
      (a!3 (or (and Z3 (not (= L4 O4)))
               (and A4 (not (= L4 P4)))
               (and X3 (not (= L4 M4)))
               (and Y3 (not (= L4 N4)))))
      (a!4 (or (and Z3 (not (= M4 O4)))
               (and A4 (not (= M4 P4)))
               (and W3 (not (= M4 L4)))
               (and Y3 (not (= M4 N4)))))
      (a!5 (or (and Z3 (not (= N4 O4)))
               (and A4 (not (= N4 P4)))
               (and W3 (not (= N4 L4)))
               (and X3 (not (= N4 M4))))))
  (and (or (and Z3 a!1) (and A4 a!2) (and W3 a!3) (and X3 a!4) (and Y3 a!5))
       (<= 3.0 Q4)))
      )
      false
    )
